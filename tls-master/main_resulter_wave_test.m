...
SAR_image_path = 'vie1_0R.jpg';
Sigma_noise_flg = 0 ; % it must estimated from noisy img
    my_img_sz = 512
...
[noise_info,res_table1,Info_line,xr_0R] = resulter_wave_test (exp(X_0R),'vie1_0R.jpg', Sigma_noise,[1], [1 2], 'BCGM');
[noise_info,res_table2,Info_line,xr_1R] = resulter_wave_test (exp(X_1R), 'vie1_0R.jpg',Sigma_noise,[1], [1 2], 'BCGM');
[noise_info,res_table3,Info_line,xr_2R] = resulter_wave_test (exp(X_2R), 'vie1_0R.jpg',Sigma_noise,[1], [1 2], 'BCGM');
[noise_info,res_table4,Info_line,xr_3R] = resulter_wave_test (exp(X_3R), 'vie1_0R.jpg',Sigma_noise,[1], [1 2], 'BCGM');
